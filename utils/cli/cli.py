...
###############################################################################
# HISTORY:
#   0.0.1   Aug10 MR The first working version of the script; limited testing
#                    performed, but seems to work fine.
#
###############################################################################
NAME = "BS Log analyzer"
VERSION = "0.0.1"
AUTHOR = "Miran R."
...
_HELPTEXT = """
This command is used to display help. 
If command without arguments is used, all know commands are listed with
short description. If 'help <command-name> is issued, the complete info
about the <command-name> is displayed."""
